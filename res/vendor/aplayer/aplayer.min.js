! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("APlayer", [], t) : "object" == typeof exports ? exports.APlayer = t() : e.APlayer = t() }(this, function() {
    return function(e) {
        function t(l) {
        ...
        var i = [],
            n = function() {
                function e(t) {
                    ...
                    var s = { element: document.getElementsByClassName("aplayer")[0], narrow: !1, autoplay: !1, mutex: !0, showlrc: 0, theme: "#b7daff", mode: "circulation" };
                    ...
                    if (this.playIndex = "[object Array]" === Object.prototype.toString.call(t.music) ? 0 : -1, this.option = t, this.audios = [], this.mode = t.mode, this.secondToTime = function(e) {
                            ...
                            return e >= 3600 ? t(r) + ":" + t(i) + ":" + t(l) : t(a) + ":" + t(l) }, this.element = this.option.element, 2 === this.option.showlrc || this.option.showlrc === !0) { this.savelrc = [];
                    ...
                    this.lrcs = [], this.updateBar = function(e, t, a) { t = t > 0 ? t : 0, t = t < 1 ? t : 1, m[e + "Bar"].style[a] = 100 * t + "%" }, this.updateLrc = function() {
                        ...
                        if (n.lrcIndex > n.lrc.length - 1 || e < n.lrc[n.lrcIndex][0] || !n.lrc[n.lrcIndex + 1] || e >= n.lrc[n.lrcIndex + 1][0])
                            for (var t = 0; t < n.lrc.length; t++) e >= n.lrc[t][0] && (!n.lrc[t + 1] || e < n.lrc[t + 1][0]) && (n.lrcIndex = t, n.lrcContents.style.transform = "translateY(" + 16 * -n.lrcIndex + "px)", n.lrcContents.style.webkitTransform = "translateY(" + 16 * -n.lrcIndex + "px)", n.lrcContents.getElementsByClassName("aplayer-lrc-current")[0].classList.remove("aplayer-lrc-current"), n.lrcContents.getElementsByTagName("p")[t].classList.add("aplayer-lrc-current")) };
                    var d = ["play", "pause", "canplay", "playing", "ended", "error"];
                    this.event = {};
                    for (var u = 0; u < d.length; u++) this.event[d[u]] = [];
                    this.trigger = function(e) {
                        for (var t = 0; t < n.event[e].length; t++) n.event[e][t]() }, this.multiple = this.playIndex > -1, this.music = this.multiple ? this.option.music[this.playIndex] : this.option.music, this.option.showlrc && this.element.classList.add("aplayer-withlrc"), this.option.music.length > 1 && this.element.classList.add("aplayer-list"), this.multiple || "circulation" === this.mode || "order" === this.mode || (this.mode = "circulation"), this.getRandomOrder();
                    ...
                    var m = {};
                    m.barWrap = this.element.getElementsByClassName("aplayer-bar-wrap")[0], this.option.narrow && this.element.classList.add("aplayer-narrow"), this.button = this.element.getElementsByClassName("aplayer-button")[0], this.button.addEventListener("click", function(e) { n.toggle() }), this.multiple && ! function() {
                        for (var e = n.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li"), t = function(t) { e[t].addEventListener("click", function() {
                                    var a = parseInt(e[t].getElementsByClassName("aplayer-list-index")[0].innerHTML) - 1;
                                    a !== n.playIndex ? (n.setMusic(a), n.play()) : n.toggle() }) }, a = 0; a < n.option.music.length; a++) t(a) }(), m.playedBar = this.element.getElementsByClassName("aplayer-played")[0], m.loadedBar = this.element.getElementsByClassName("aplayer-loaded")[0];
                    ...
                    var g = function(e) {
                        ...
                        b = function E() { document.removeEventListener("mouseup", E), document.removeEventListener("mousemove", g), n.audio.currentTime = parseFloat(m.playedBar.style.width) / 100 * n.audio.duration, n.playedTime = setInterval(function() { n.updateBar("played", n.audio.currentTime / n.audio.duration, "width"), n.option.showlrc && n.updateLrc(), n.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = n.secondToTime(n.audio.currentTime), n.trigger("playing") }, 100) };
                    f.addEventListener("mousedown", function() { v = m.barWrap.clientWidth, clearInterval(n.playedTime), document.addEventListener("mousemove", g), document.addEventListener("mouseup", b) }), m.volumeBar = this.element.getElementsByClassName("aplayer-volume")[0];
                ...
                return r(e, [{ key: "setMusic", value: function(e) {
                            ...
                            t.lrcs[e] || ! function() {
                                ...
                                1 === t.option.showlrc ? a = t.multiple ? t.option.music[e].lrc : t.option.music.lrc : 2 === t.option.showlrc || t.option.showlrc === !0 ? a = t.savelrc[e] : 3 === t.option.showlrc && ! function() {
                                    ...
                                    r.onreadystatechange = function() {
                                        if (4 === r.readyState)
                                            if (r.status >= 200 && r.status < 300 || 304 === r.status) { a = r.responseText, t.lrcs[e] = l(a), t.lrc = t.lrcs[e];
                                                var i = "";
                                                t.lrcContents = t.element.getElementsByClassName("aplayer-lrc-contents")[0];
                                                for (var n = 0; n < t.lrc.length; n++) i += "<p>" + t.lrc[n][1] + "</p>";
                                                t.lrcContents.innerHTML = i, t.lrcIndex || (t.lrcIndex = 0), t.lrcContents.getElementsByTagName("p")[0].classList.add("aplayer-lrc-current"), t.lrcContents.style.transform = "translateY(0px)", t.lrcContents.style.webkitTransform = "translateY(0px)" } else console.log("Request was unsuccessful: " + r.status) };
                                    var i = void 0;
                                    i = t.multiple ? t.option.music[e].lrc : t.option.music.lrc, r.open("get", i, !0), r.send(null) }(), a ? t.lrcs[e] = l(a) : t.lrcs[e] = [
                                    ["00:00", "Loading"]
                                ] }(), t.lrc = t.lrcs[e];
                            var r = "";
                            t.lrcContents = t.element.getElementsByClassName("aplayer-lrc-contents")[0];
                            for (var i = 0; i < t.lrc.length; i++) r += "<p>" + t.lrc[i][1] + "</p>";
                        ...
                        if ("[object Number]" === Object.prototype.toString.call(e) && (this.audio.currentTime = e), this.button.classList.contains("aplayer-play")) {
                            if (this.button.classList.remove("aplayer-play"), this.button.classList.add("aplayer-pause"), this.button.innerHTML = "", setTimeout(function() { t.button.innerHTML = '\n                            <button class="aplayer-icon aplayer-icon-pause">' + t.getSVG("pause") + "     </button>" }, 100), this.option.mutex)
                                for (var a = 0; a < i.length; a++) this != i[a] && i[a].pause();
                            this.audio.play(), this.playedTime && clearInterval(this.playedTime), this.playedTime = setInterval(function() { t.updateBar("played", t.audio.currentTime / t.audio.duration, "width"), t.option.showlrc && t.updateLrc(), t.ptime.innerHTML = t.secondToTime(t.audio.currentTime), t.trigger("playing") }, 100), this.trigger("play") } } }, { key: "pause", value: function() {
                        var e = this;
                        (this.button.classList.contains("aplayer-pause") || this.ended) && (this.ended = !1, this.button.classList.remove("aplayer-pause"), this.button.classList.add("aplayer-play"), this.button.innerHTML = "", setTimeout(function() { e.button.innerHTML = '\n                            <button class="aplayer-icon aplayer-icon-play">' + e.getSVG("play") + "     </button>" }, 100), this.audio.pause(), clearInterval(this.playedTime), this.trigger("pause")) } }, { key: "volume", value: function(e) { this.updateBar("volume", e, "height"), this.audio.volume = e, this.audio.muted && (this.audio.muted = !1), 1 === e ? (this.volumeicon.className = "aplayer-icon aplayer-icon-volume-up", this.volumeicon.innerHTML = this.getSVG("volume-up")) : (this.volumeicon.className = "aplayer-icon aplayer-icon-volume-down", this.volumeicon.innerHTML = this.getSVG("volume-down")) } }, { key: "on", value: function(e, t) { "function" == typeof t && this.event[e].push(t) } }, { key: "toggle", value: function() { this.button.classList.contains("aplayer-play") ? this.play() : this.button.classList.contains("aplayer-pause") && this.pause() } }, { key: "getRandomOrder", value: function() {
                        function e(e, t) {
                            return null == t && (t = e, e = 0), e + Math.floor(Math.random() * (t - e + 1)) }

                        function t(t) {
                            for (var a, l = t.length, r = new Array(l), i = 0; i < l; i++) a = e(0, i), a !== i && (r[i] = r[a]), r[a] = t[i];
                            return r }
                        if (this.multiple) {
                            if (!this.normalOrder) { this.normalOrder = [];
                                for (var a = 0; a < this.option.music.length; a++) this.normalOrder[a] = a }
                            this.randomOrder = t(this.normalOrder) } } }, { key: "nextRandomNum", value: function() {
                        if (this.multiple) {
        ...
        var l = a(2); "string" == typeof l && (l = [
            [e.id, l, ""]
        ]);
        a(5)(l, {});
        l.locals && (e.exports = l.locals) }, function(e, t, a) {
        ...
        function l(e, t) {
            for (var a = 0; a < e.length; a++) {
                ...
                if (r) { r.refs++;
                    ...
                    for (; i < l.parts.length; i++) r.parts.push(p(l.parts[i], t)) } else {
                    for (var n = [], i = 0; i < l.parts.length; i++) n.push(p(l.parts[i], t));
        ...
        function i(e, t) {
            var a = f(),
                l = b[b.length - 1];
            if ("top" === e.insertAt) l ? l.nextSibling ? a.insertBefore(t, l.nextSibling) : a.appendChild(t) : a.insertBefore(t, a.firstChild), b.push(t);
            else {
        ...
        function d(e, t) {
            var a = t.css,
                l = t.media;
            if (l && e.setAttribute("media", l), e.styleSheet) e.styleSheet.cssText = a;
            else {
